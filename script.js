...
const slova = [
    ...
    { bukva: "Ю", text: "Юркая - твоей любознательности нет гранциц. Ты словно знаешь все и готова ко всему." },
    { bukva: "Б", text: "Бойкая - твердая телом и характером, несламимый дух и принципы." },
    { bukva: "Л", text: "Легкая - с тобой душа просится летать." },
    { bukva: "Ю", text: "Юморная - твоя вечная улыбка и игривый взгляд - ценныя черты твоей души." }
];
